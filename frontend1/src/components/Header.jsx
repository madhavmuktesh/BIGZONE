      ...
      <div className="container">
        <div className="header-content">
          ...
          <div className="header-actions">
            ...
            {/* Action Buttons */}
            <Link to="/support">
              <button className="cart-button">📞 Support</button>
            </Link>
            <Link to="/address">
              <button className="cart-button">🏠 Address</button>
            </Link>
            <Link to="/orders">
              <button className="cart-button">📦 Orders</button>
            </Link>
            <Link to="/cart">
